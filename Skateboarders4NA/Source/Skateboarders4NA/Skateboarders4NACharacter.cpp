...
ASkateboarders4NACharacter::ASkateboarders4NACharacter()
{
...
void ASkateboarders4NACharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASkateboarders4NACharacter::Move);
...
void ASkateboarders4NACharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
